...
def configurate_logger(log_filepath): #TODO: Change it so Terminal and Logfile get different log messages but stay clear! Potentially move out to new module
	LOGFILE_LEVEL = 15
